var locations = [
	["Odonno's Gelati", 51.49362191787874, -0.17623186111450195, "category2", 'Offers 10% student discount </p><a href="http://www.oddonos.com/index.html" target="blank">Visit website</a>', 1],
	...
	["Oriental Canteen", 51.49459715709654, -0.17327606678009033, "category1", 'No current student discount offered</p> <a href="https://www.tripadvisor.co.uk/Restaurant_Review-g186338-d1007176-Reviews-Oriental_Canteen-London_England.html" target="blank">View on TripAdvisor</a>', 0],
	...
	["Fulham Tarts", 51.4975695040852, -0.1844179630279541, "category1", 'Delicious iced cofee and various salads </p> <a href="https://www.tripadvisor.co.uk/Restaurant_Review-g186338-d7607262-Reviews-Fulham_Tarts-London_England.html" target="blank">View on TripAdvisor</a>', 0]
]
var markers = [];
var i, newMarker;
...
function initMap() {
	...
	for (i = 0; i < locations.length; i++) {
		...
		bounds.extend(new google.maps.LatLng(newMarker.position.lat(), newMarker.position.lng()));
	}
